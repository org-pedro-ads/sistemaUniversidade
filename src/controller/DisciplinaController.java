...
public class DisciplinaController {
    ...
    public void cadastrarDisciplina() throws Exception {
        try {
            ...
            if (professorResponsavel == null) {
                view.print("Erro: Professor com matricula " + matriculaProfessor + " não encontrado. Cadastro cancelado.");
                return;
            }
    ...
    public Alunos matricularAluno() throws Exception {
        try{
            ...
            Disciplina disciplinaAtualizada = repo.buscarDisciplinaPorId(idDisciplina); // Declared disciplinaAtualizada
